...
import com.myshop.entity.dtos.SignRecordMessageDTO;
import com.myshop.entity.po.UserSignRecord;
import com.myshop.entity.po.UserSignRecordDetail;
import com.myshop.mappers.UserSignRecordDetailMapper;
...
public class SignRecordListenerComponent {
    ...
    @Resource
    private UserSignRecordMapper<UserSignRecord, com.myshop.entity.query.UserSignRecordQuery> userSignRecordMapper;
    @Resource
    private UserSignRecordDetailMapper<UserSignRecordDetail, com.myshop.entity.query.UserSignRecordDetailQuery> userSignRecordDetailMapper;
    @Resource
