...
import com.myshop.component.SensitiveWordCacheComponent;
...
import com.myshop.mappers.SensitiveWordMapper;
...
public class SensitiveWordServiceImpl implements SensitiveWordService {
    ...
    public PaginationResultVO<SensitiveWord> findListByPage(SensitiveWordQuery query) {
        ...
        query.setSimplePage(new com.myshop.entity.query.SimplePage(pageNo, count, pageSize));
