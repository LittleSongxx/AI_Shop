...
import com.myshop.biz.CouponReminderService;
...
public class CouponReminderServiceImpl implements CouponReminderService {
    ...
    @Resource
    private UserCouponMapper<com.myshop.entity.po.UserCoupon, com.myshop.entity.query.UserCouponQuery> userCouponMapper;
    @Resource
