...
import com.myshop.mappers.SkuStockMapper;
...
public class SkuStockService {
    ...
    public com.myshop.entity.vo.PaginationResultVO<SkuStockDTO> listLessThan(Integer pageNo, Integer pageSize, Integer threshold) {
        ...
        com.myshop.entity.query.SimplePage page = new com.myshop.entity.query.SimplePage(no, count, size);
        ...
        return new com.myshop.entity.vo.PaginationResultVO<>(count, page.getPageSize(), page.getPageNo(), page.getPageTotal(), list);
    }
