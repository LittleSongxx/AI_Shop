...
Run：`customer-service-http-v16-20260825`；样本：`60`；数据 SHA-256：`112dfd6ba7546b7cbad317597d944e3ab4dc02627d4ca6018733031d8eddc527`。
...
- 本地全链路延迟 P50/P95/P99：`1009.851/1892.038/7844.328 ms`，不是生产 SLO。
- Usage：input/output token `24516/801`，Provider calls `7`，费用状态 `UNPRICED`，costCny `None`。未知费用不记为 0。
