...
Run：`customer-service-http-v56-full-v3-knowledge-regressions-20260827`；样本：`120`；数据 SHA-256：`02a6dacc6a2aadb88c6dfb60bf7a74e2f083fcba0f9a6e82fef38c4dfa82caf3`。
...
- 本地全链路延迟 P50/P95/P99：`613.925/1377.723/8727.084 ms`，不是生产 SLO。
- Usage：input/output token `34290/1463`，Provider calls `11`，费用状态 `UNPRICED`，costCny `None`。未知费用不记为 0。
