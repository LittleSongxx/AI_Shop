...
Run：`customer-service-http-v17-20260825`；样本：`60`；数据 SHA-256：`112dfd6ba7546b7cbad317597d944e3ab4dc02627d4ca6018733031d8eddc527`。
...
- 本地全链路延迟 P50/P95/P99：`1026.7/1806.799/7851.842 ms`，不是生产 SLO。
- Usage：input/output token `15280/613`，Provider calls `5`，费用状态 `UNPRICED`，costCny `None`。未知费用不记为 0。
- 运行质量诊断（非人工真值）：Verifier observed/pass `46/41`；安全降级 `5`；澄清生效 `8`；硬约束违规 `0`，badcase：`无`。
