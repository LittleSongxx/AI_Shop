...
Run：`customer-service-http-v35-handoff-metric-v2-targeted-20260826`；样本：`3`；数据 SHA-256：`ab5129a73cf6f986173d92e3f5f04ab7e8689bae9ad4c7d7294fa13b587ee079`。
...
- HTTP 执行：`3/3`；转人工混淆矩阵：`{'truePositive': 1, 'falsePositive': 0, 'falseNegative': 0, 'trueNegative': 2}`。
- 引用结构无效：`0`，case：`无`；语义支持仍由人工评分。
- 本地全链路延迟 P50/P95/P99：`1363.14/10771.142/11607.409 ms`，不是生产 SLO。
- Usage：input/output token `17265/538`，Provider calls `4`，费用状态 `UNPRICED`，costCny `None`。未知费用不记为 0。
