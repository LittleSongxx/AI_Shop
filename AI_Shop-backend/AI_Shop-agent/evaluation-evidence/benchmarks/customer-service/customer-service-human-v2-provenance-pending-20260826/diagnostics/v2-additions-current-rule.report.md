...
数据集：`60` 条；SHA-256：`364366c64d8cb2aa5efb57a4de2e2fa8dac819c5d30849e2a634d86e0b2713c1`；模式：`rule`。
...
|---|---:|---:|---|---:|
| `intentMacroF1` | 0.448333 | 8.966668/20 | [0.337852, 0.52247] | 31 |
| `highRiskIntentRecall` | 0.2 | 1/5 | [0.036224, 0.624465] | 4 |
| `slotEntitySpanF1` | 0.258427 | 92/356 | [0.176936, 0.330582] | 35 |
| `slotExactMatch` | 0.027778 | 1/36 | [0.00492, 0.141697] | 35 |
| `handoffRecall` | 0.444444 | 8/18 | [0.245595, 0.662836] | 10 |
| `criticalHandoffMissRate` | 0.6 | 3/5 | [0.230724, 0.882379] | 3 |

## 证据版本边界

- 当前 60 条规则预路由结果绑定本报告数据集；它是输入理解/路由诊断，不是 HTTP 最终答案质量或新 holdout 泛化结果。
...
- `canonicalSlotEntitySpanF1`：0.322034 （76/236，95% CI [0.256198, 0.390047]，badcase `cs-candidate-v2-061, cs-candidate-v2-062, cs-candidate-v2-067, cs-candidate-v2-076, cs-candidate-v2-079, cs-candidate-v2-080, cs-candidate-v2-085, cs-candidate-v2-086, cs-candidate-v2-088, cs-candidate-v2-089, cs-candidate-v2-091, cs-candidate-v2-097, cs-candidate-v2-098, cs-candidate-v2-099, cs-candidate-v2-103, cs-candidate-v2-105, cs-candidate-v2-106, cs-candidate-v2-109, cs-candidate-v2-111, cs-candidate-v2-116, cs-candidate-v2-119`）。
- `canonicalSlotExactMatch`：0.086957 （2/23，95% CI [0.02418, 0.26796]，badcase `cs-candidate-v2-061, cs-candidate-v2-062, cs-candidate-v2-067, cs-candidate-v2-076, cs-candidate-v2-079, cs-candidate-v2-080, cs-candidate-v2-085, cs-candidate-v2-086, cs-candidate-v2-088, cs-candidate-v2-089, cs-candidate-v2-091, cs-candidate-v2-097, cs-candidate-v2-098, cs-candidate-v2-099, cs-candidate-v2-103, cs-candidate-v2-105, cs-candidate-v2-106, cs-candidate-v2-109, cs-candidate-v2-111, cs-candidate-v2-116, cs-candidate-v2-119`）。
...
当前 60 条点估计未通过参考门槛：intentMacroF1, highRiskIntentRecall, slotEntitySpanF1, slotExactMatch, handoffRecall, criticalHandoffMissRate；这些门槛不是统一行业标准，也不能替代人工答案质量。
样本量、切片覆盖和评测模式仍不足以推出行业级稳定性或线上质量。
扩展切片：account-compromise=1; account-safety=1; acknowledgement=1; address-change=3; aftersales-boundary=1; aftersales-unknown=3; ambiguous=1; amount-mismatch=1; amount-slot=1; battery-safety=1; budget=2; cancel-negation=1; cancel-order=3; canonical-slot=5; chat=3; chinese-number=1; comparison=1; complaint=3; complaint-negation=1; conditional-handoff=1; confirm-receipt=3; consult-negation=1; consult-search-boundary=1; contextual=1; critical-handoff=9; currency-wording=1; damaged-item=1; deadline=1; discount-boundary=1; duplicate-charge=1; duplicate-order=1; elliptical=2; elliptical-product=1; explicit-handoff=3; false-delivery=1; follow-up-review=1; fulfillment-boundary=1; full-width-currency=1; handoff=3; human-request=3; intent-boundary=2; invoice=3; logistics-boundary=2; missing-item=1; missing-record=1; negated-handoff=2; negated-write=1; negation=6; negative-brand=1; negative-constraint=1; no-secret=1; order-id=8; out-of-domain=1; payment-issue=3; pending=1; policy-before-action=1; policy-negation=1; policy-question=4; positive-review=1; post-dispatch=1; presale=1; price-feedback=1; privacy=1; product-consult=3; product-name=2; product-review=3; product-search=3; quantity=3; query-coupon=3; query-fulfillment=3; query-logistics=3; query-order=3; recomment=3; refund=3; refund-negation=1; refund-status=3; refund-status-boundary=1; retry-question=1; search-negation=1; service-quality=1; stale-tracking=1; state-conflict=2; terminology=1; threshold=1; time-wording=2; underspecified=1; unknown-outcome=1; use-case=1; use-case-feedback=1; write-intent=2; wrong-item=1

## Intent 明细

| Intent | support | Precision | Recall | F1 | badcase |
|---|---:|---:|---:|---:|---:|
| `ADDRESS_CHANGE` | 3 | 1.0 | 0.666667 | 0.8 | cs-candidate-v2-061 |
| `AFTERSALES_UNKNOWN` | 2 | 0.333333 | 0.5 | 0.4 | cs-candidate-v2-065 |
| `CANCEL_ORDER` | 3 | 0.5 | 0.333333 | 0.4 | cs-candidate-v2-067, cs-candidate-v2-069 |
| `CHAT` | 3 | 0.176471 | 1.0 | 0.3 | 无 |
| `COMPLAINT` | 2 | 0.5 | 0.5 | 0.5 | cs-candidate-v2-075 |
| `CONFIRM_RECEIPT` | 3 | 1.0 | 0.666667 | 0.8 | cs-candidate-v2-078 |
| `DAMAGED_OR_WRONG_ITEM` | 2 | 0.5 | 0.5 | 0.5 | cs-candidate-v2-079 |
| `HUMAN_REQUEST` | 11 | 0.857143 | 0.545455 | 0.666667 | cs-candidate-v2-066, cs-candidate-v2-074, cs-candidate-v2-083, cs-candidate-v2-084, cs-candidate-v2-117 |
| `INVOICE` | 2 | 1.0 | 0.5 | 0.666667 | cs-candidate-v2-085 |
| `PAYMENT_ISSUE` | 3 | 1.0 | 0.333333 | 0.5 | cs-candidate-v2-089, cs-candidate-v2-090 |
| `PRODUCT_CONSULT` | 3 | 0.0 | 0.0 | 0.0 | cs-candidate-v2-091, cs-candidate-v2-092, cs-candidate-v2-093 |
| `PRODUCT_REVIEW` | 3 | 1.0 | 0.333333 | 0.5 | cs-candidate-v2-095, cs-candidate-v2-096 |
| `PRODUCT_SEARCH` | 3 | 0.428571 | 1.0 | 0.6 | 无 |
| `QUERY_COUPON` | 2 | 1.0 | 0.5 | 0.666667 | cs-candidate-v2-100 |
| `QUERY_FULFILLMENT` | 3 | 0.0 | 0.0 | 0.0 | cs-candidate-v2-103, cs-candidate-v2-104, cs-candidate-v2-105 |
| `QUERY_LOGISTICS` | 2 | 0.5 | 1.0 | 0.666667 | 无 |
| `QUERY_ORDER` | 3 | 1.0 | 0.333333 | 0.5 | cs-candidate-v2-110, cs-candidate-v2-111 |
| `RECOMMENT` | 3 | 0.0 | 0.0 | 0.0 | cs-candidate-v2-112, cs-candidate-v2-113, cs-candidate-v2-114 |
| `REFUND` | 2 | 0.333333 | 1.0 | 0.5 | 无 |
| `REFUND_STATUS` | 2 | 0.0 | 0.0 | 0.0 | cs-candidate-v2-118, cs-candidate-v2-119 |
