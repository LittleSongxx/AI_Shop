...
> `POST_WORKER_RESTART_TARGETED_DIAGNOSTIC`；答案质量仍待独立人工盲审，不进入 release gate。

Run：`customer-service-http-v12-targeted-after-worker-restart-20260824`；样本：`10`；数据 SHA-256：`112dfd6ba7546b7cbad317597d944e3ab4dc02627d4ca6018733031d8eddc527`。
...
- 本地全链路延迟 P50/P95/P99：`818.435/1604.444/1659.708 ms`，不是生产 SLO。
