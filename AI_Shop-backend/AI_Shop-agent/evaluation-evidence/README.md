...
| 客服 HTTP 与排错证据 | `customer-service-http-v1-20260823/`、`customer-service-http-v13-20260824/`、`customer-service-http-v13-pre-evaluator-fix-20260824/`、`customer-service-http-v14-20260825/`、`customer-service-http-v16-20260825/`、`customer-service-http-v17-20260825/`、`customer-service-http-v18-20260825/`、`customer-service-http-v20-20260825/`、`customer-service-http-v11-targeted-stale-worker-20260824/`、`customer-service-http-v12-targeted-after-worker-restart-20260824/`、`customer-service-slot-replay-v1-20260823/` | v14 是真实 live observation；v16/v17/v18/v20 是保留 observation 的离线重算；另含评测器修复前快照、运行时版本对照和 slot paired replay；均为诊断/追溯，不自动成为 release gate |
