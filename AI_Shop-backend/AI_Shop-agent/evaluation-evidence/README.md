...
| 客服 HTTP 与排错证据 | `customer-service-http-v1-20260823/`、`customer-service-http-v13-20260824/`、`customer-service-http-v13-pre-evaluator-fix-20260824/`、`customer-service-http-v11-targeted-stale-worker-20260824/`、`customer-service-http-v12-targeted-after-worker-restart-20260824/`、`customer-service-slot-replay-v1-20260823/` | 原始 observation、评测器修复前快照、运行时版本对照、slot paired replay；均为诊断/追溯，不自动成为 release gate |
