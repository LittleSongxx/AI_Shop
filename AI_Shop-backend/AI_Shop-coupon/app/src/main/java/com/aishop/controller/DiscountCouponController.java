...
import com.aishop.annotation.CouponRushRateLimit;
...
import com.aishop.api.vo.UserCouponDetailVO;
...
public class DiscountCouponController extends ABaseController{
    ...
    public ResponseVO loadUserCoupon(@NotNull Integer pageNo, Integer status) {
        ...
        query.setOrderBy(com.aishop.entity.query.SafeSort.of("use_time desc, user_coupon_id desc"));
        // 我的优惠券页默认不展示"已作废"
