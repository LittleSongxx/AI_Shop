...
public class LocationWeatherServiceImpl implements LocationWeatherService {
    ...
    private static final String USER_AGENT = "AI_Shop/1.0 (location; contact=dev@aishop.local)";
    ...
    public void saveUserCoords(String userId, Double latitude, Double longitude, LocationWeatherVO resolved) {
        com.aishop.entity.dto.UserLocationCoordsDTO coords = new com.aishop.entity.dto.UserLocationCoordsDTO();
