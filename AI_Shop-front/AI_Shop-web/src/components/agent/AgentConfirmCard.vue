...
const effectiveStatus = computed(() => {
  return normalizeAgentActionStatus(
    localStatus.value ?? props.card.status ?? AGENT_ACTION_STATUS.PENDING
  );
});
...
const statusLabel = computed(() => agentActionStatusLabel(effectiveStatus.value));
